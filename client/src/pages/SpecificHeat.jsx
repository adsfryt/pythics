        ...
        <div className="qw">
            ...
            <div className="centercontent">
                ...
                <p className="txt">Вам уже известно, что внутренняя энергия тела может изменяться как путём совершения работы, так и путём теплопередачи.
                    Если изменение внутренней энергии происходит путём теплопередачи, то переход энергии от одних тел к другим осуществляется
                    <mark className="mrk">теплопроводностью</mark>, <mark className="mrk">конвекцией</mark> или <mark className="mrk">излучением</mark>.</p>
